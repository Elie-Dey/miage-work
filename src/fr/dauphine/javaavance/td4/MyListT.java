...
public class MyListT <T>{
    ...
    public int size(){
        ...
        while (currentCell != null){
            numberOfElements++;
            currentCell = currentCell.getNextCellT();
        }
    ...
    public String toString(){
        ...
        while (currentCell != null){
            ...
            if (currentCell.getNextCellT() == null) {
                str = str + currentCell.getValueT();
            } else {
                str = str + currentCell.getValueT() + ", ";
            }
    ...
    public void addLast(T value)throws  NullPointerException{
        ...
        CellT myEndCell = new CellT(value);
        myEndCell.setNextCellT(null);

        //Verification si la liste n'est pas vide alors on ajoute
        // le valeur dans la premiere Cell donc le Head
        if (head == null) {
            head = new CellT(value);
            return;
        }

        // Sinon definition par defaut de head comme la derniere Cell de notre liste

        CellT defaultEndCellOfList  = head;
        while (defaultEndCellOfList.getNextCellT() != null){
            defaultEndCellOfList = defaultEndCellOfList.getNextCellT();
        }
        ...
        defaultEndCellOfList.setNextCellT(myEndCell);
    }
    ...
    public void add(T value, int index){
        ...
        currentCell.getNextCellT().setValueT(value);
    }
    ...
    public String get(int index) throws IndexOutOfBoundsException{
        ...
        CellContent+= currentCell.getValueT();
...
//            return somme;
//        while (currentCell != null){
//            somme = somme +  currentCell.getValueT().length();
//            currentCell = currentCell.getNextCellT();
//        }
//        return somme;
//    }
